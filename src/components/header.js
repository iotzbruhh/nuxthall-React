  ...
  return (
    <div data-role="Header" className={`header-header ${props.rootClassName} `}>
      <div className="header-container">
        ...
        <Link to="/profile" className="header-navlink01">
          <div className="header-container1">
            ...
            <span className="header-text TextSM">Community</span>
          </div>
        </Link>
        <Link to="/blog-post" className="header-navlink02">
          <div className="header-container2">
            ...
            <span className="header-text1 TextSM">Tentang</span>
          </div>
        </Link>
          ...
          <ul data-thq="thq-dropdown-list" className="header-dropdown-list">
            <li data-thq="thq-dropdown" className="header-dropdown list-item">
              <Link to="/" className="">
                ...
                >
                  <span className="header-text2">Home</span>
                </div>
              </Link>
            </li>
            <li data-thq="thq-dropdown" className="header-dropdown1 list-item">
              <Link to="/profile" className="">
                ...
                >
                  <span className="header-text3">Join</span>
                </div>
              </Link>
            </li>
            <li data-thq="thq-dropdown" className="header-dropdown2 list-item">
              <Link to="/blog-post" className="">
                <div
                  data-thq="thq-dropdown-toggle"
      ...
      <Link to="/blog-post" className="header-navlink06">
        <div className="header-container3">
          <span className="header-text5 TextSM">Join Us!</span>
        </div>
      </Link>
      <div data-role="MobileMenu" className="header-mobile-menu">
        <div className="header-top">
          <Link to="/" className="header-navlink07">
        ...
        <div className="header-mid">
          <Link to="/profile" className="header-navlink08">
            <div className="header-container4">
              ...
              <span className="header-text6 TextSM">PROFILE</span>
            </div>
          </Link>
          <Link to="/blog-post" className="header-navlink09">
            <div className="header-container5">
              ...
              <span className="header-text7 TextSM">BLOG</span>
            </div>
          </Link>
        </div>
